...
import org.themselves.alber.controller.common.dto.ImageIdDto;
...
public class CommonController {
    ...
    public ResponseEntity<ResponseContent<ImageIdDto>> addImage(
              @RequestParam("file") MultipartFile file) {

        Long imageId = commonService.imageFileUpload(file);
        ImageIdDto imageDto = new ImageIdDto();
